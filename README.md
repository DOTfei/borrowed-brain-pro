...
> **Distill any public figure's thinking into a structured profile — then use it as a lens (or contrast multiple lenses) on a real decision you're facing.**
...
⚠️ Where it likely breaks down: The principle was reactive, not proactive — instituted AFTER an 800k subscriber drop and 77% stock collapse.
```
...
| ✍️ **[Julia Evans](profiles/julia-evans.md)** | Technical Writing | Explaining hard topics simply, writing for past self, clear documentation |
...
| :--- | :--- | :--- |
| **Claude Code (CLI)** | 🟢 **Git Clone (Native Skill)** | `git clone https://github.com/DOTfei/borrowed-brain-pro.git ~/.claude/skills/borrowed-brain-pro` |
...
## 🛡️ Built-in Epistemic Guardrails
...
<p center>
  <i>License: <a href="LICENSE">MIT</a> · Maintained by <a href="https://github.com/DOTfei">DOTfei</a></i>
</p>
